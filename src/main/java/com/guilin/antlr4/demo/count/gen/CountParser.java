...
public class CountParser extends Parser {
    ...
    public static class ListContext extends ParserRuleContext {
        public List<TerminalNode> INT() {
            return getTokens(CountParser.INT);
        }

        public TerminalNode INT(int i) {
            return getToken(com.guilin.antlr4.demo.count.gen.CountParser.INT, i);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof com.guilin.antlr4.demo.count.gen.CountListener)
                ((com.guilin.antlr4.demo.count.gen.CountListener) listener).enterList(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof com.guilin.antlr4.demo.count.gen.CountListener)
                ((CountListener) listener).exitList(this);
        }
